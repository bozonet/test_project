# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-26 09:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='contact',
            name='password',
            field=models.CharField(default=datetime.datetime(2016, 7, 26, 9, 1, 55, 532000, tzinfo=utc), max_length=128, verbose_name='password'),
        ...
        migrations.AddField(
            model_name='contact',
            name='item',
            field=models.ForeignKey(default=datetime.datetime(2016, 7, 26, 9, 1, 40, 908000, tzinfo=utc), on_delete=django.db.models.deletion.CASCADE, to='bildirge.Doc'),
            preserve_default=False,
        ),
    ]
