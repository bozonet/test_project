# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-25 07:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cinsiyet', models.CharField(choices=[(None, 'Lutfen seciniz'), ('M', 'Erkek'), ('F', 'Bayan')], default='Lutfen seciniz', max_length=1)),
                ('unvan', models.CharField(choices=[(None, 'Lutfen seciniz'), ('P', 'Prof. Dr.'), ('D', 'Doc. Dr.'), ('Y', 'Yard. Doc. Dr.'), ('U', 'Uzm. Dr.'), ('Dr', 'Dr.'), ('B', 'Biyolog'), ('O', 'Ogr. Gor.'), ('A', 'Aras. Gor.'), ('T', 'Teknisyen'), ('M', 'Muhendis'), ('D.O.', 'Doktora Ogrencisi'), ('Mr', 'Bay'), ('Ms', 'Bayan')], default=None, max_length=2)),
        ...
        migrations.AddField(
            model_name='myuser',
            name='bolum',
            field=models.CharField(default='Burasi doldurulmalidir', max_length=20),
        ),
        migrations.AddField(
            model_name='myuser',
            name='gorev',
